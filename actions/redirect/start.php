...
if (isset($_GET['page']) && !empty($_GET['page'])){
    ...
    if($_GET['page'] == "user_recovery"){
        ...
        require 'public/page/site_element/start/user_recovery.php';
        ...
        require 'public/page/site_element/start/user_password_recovery.php';

    }else{

        require 'actions/start/user_login.php';

        require 'public/page/site_element/start/user_login.php';
